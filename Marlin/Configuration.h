...
#define STRING_CONFIG_H_AUTHOR "subbsonik 1-12-2021.2 SKR1.4T" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR10Spro SKR1.4turbo"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 22.5, 0, 0 }
