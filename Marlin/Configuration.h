...
#define STRING_CONFIG_H_AUTHOR "subbsonik, cr10spro/skr1.4turbo v1.0" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR10sPro-SKR1.4Turbo v1.0"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 22.5, 0, -3.5 }
